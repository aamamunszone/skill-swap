...
const HowItWorksSection = () => {
  ...
  return (
    <div className="py-16 md:py-24 bg-linear-to-br from-blue-50 via-white to-cyan-50 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {steps.map((step, index) => (
            <div key={step.id} className="relative group">
              ...
              {/* Step Card */}
              <div
                className={`relative ${step.bgColor} rounded-2xl p-6 hover:shadow-xl transition-all duration-500 border-2 border-transparent hover:border-gray-200 group-hover:scale-103`}
              >
                {/* Step Number */}
