    ...
    <footer className="bg-base-200 border-t border-gray-300">
      <Container>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 py-10">
          {/* Services */}
          <nav>
            <h6 className="footer-title text-gray-900 font-bold mb-4">
              Services
            </h6>
            <div className="flex flex-col gap-2">
              <a className="link link-hover text-gray-600 hover:text-blue-600">
                Branding
              </a>
              <a className="link link-hover text-gray-600 hover:text-blue-600">
                Design
          ...
          {/* Legal */}
          <nav>
            <h6 className="footer-title text-gray-900 font-bold mb-4">Legal</h6>
            <div className="flex flex-col gap-2">
              <a className="link link-hover text-gray-600 hover:text-blue-600">
                Terms of use
              </a>
